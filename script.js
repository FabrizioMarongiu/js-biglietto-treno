...
if (age <= 17) {
    ...
    var discount = '20%';
    console.log( yourName ,'il prezzo finale è: ', finalPrice.toFixed(2) , '. Hai usufruito del 20% di sconto.'); 
    ...
    console.log( yourName , 'il prezzo finale è: ', finalPrice.toFixed(2) , '. Hai usufruito del 40% di sconto.' ); 
    var discount = '40%';
    document.getElementById('sconto').innerHTML = discount;
    document.getElementById('prezzo').innerHTML = finalPrice.toFixed(2) + " €";
} else{
    console.log( yourName , 'il prezzo finale è: ', price.toFixed(2) , '. Non abbiamo potuto applicare nessuno sconto.' ); 
